-- ═══════════════════════════════════════════════════════════════════════════
-- Data: CheckLevel, CheckBossQuest, MaterialMon, tableMon
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ─────────────────────────────────────────────────
-- CheckLevel — returns Ms, NameQuest, QuestLv, NameMon, CFrameQ, CFrameMon
-- ─────────────────────────────────────────────────
...
function CheckLevel()
    ...
    elseif _G.Sea2 then
        ...
        elseif Lv <= 1424 then
            ...
            CFrameQ = CFrame.new(5668.1372070313, 28.202531814575, -6484.6005859375)
            CFrameMon = CFrame.new(5628.482421875
