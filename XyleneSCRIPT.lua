...
ESPTab:CreateSection("Player ESP (Drawing)")
...
-- ═══════════════════════════════════════════════════════════════════════════
-- WORLD ESP (BillboardGui) — 12 TYPES
-- ═══════════════════════════════════════════════════════════════════════════
...
if InBloxFruits then
    ...
    -- Sea Events (Leviathan, Sea Beast, Ship, Terrorshark, Piranha, Shark)
    task.spawn(function()
        while wait(0.5) do
            if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
                pcall(function()
    ...
    -- Cake Prince, Dough King, Spawn Cake
    if Third_Sea then
        task.spawn(function()
            while wait(0.5) do
                pcall(function()
